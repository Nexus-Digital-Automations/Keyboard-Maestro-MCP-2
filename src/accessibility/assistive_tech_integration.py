    ...
    def _initialize_default_configurations(self) -> bool:
        ...
        self.capabilities[AssistiveTechnology.SCREEN_READER] = [
            AssistiveTechCapability(
                ...
                configuration_options={
                    "voice_speed": "adjustable",
                    "voice_pitch": "adjustable",
                },
            ),
            AssistiveTechCapability(
        ...
        self.capabilities[AssistiveTechnology.VOICE_CONTROL] = [
            ...
            AssistiveTechCapability(
                ...
                configuration_options={
                    "accuracy_mode": ["fast", "accurate"],
                    "custom_vocabulary": "supported",
                },
            ),
        ]
        ...
        self.screen_reader_configs["voiceover"] = ScreenReaderConfig(
            ...
            announcement_settings={
                ...
                "announce_typed_characters": True,
            },
            keyboard_shortcuts={
                "read_all": "Control+Option+A",
                "next_element": "Control+Option+Right",
            },
        )
