...
class AccessibilityReportGenerator:
    ...
    async def _analyze_test_results(
        ...
        try:
            ...
            overall_score = (
                total_compliance_score / total_tests if total_tests > 0 else 0.0
            )
    ...
    async def _analyze_wcag_compliance(
        ...
        try:
            ...
            criteria_compliance = {}
            principle_issues = dict.fromkeys(AccessibilityPrinciple, 0)
            ...
            return {
                ...
                "principle_scores": {
                    p.value: score for p, score in principle_scores.items()
                },
                "principle_issues": {
                    p.value: count for p, count in principle_issues.items()
                },
    ...
    async def _generate_compliance_overview_section(
        ...
        chart = {
            ...
            "data": [
                {
                    "label": "Critical",
                    "value": analysis["critical_issues"],
                    "color": "#DC3545",
                },
                {"label": "High", "value": analysis["high_issues"], "color": "#FD7E14"},
                {
                    "label": "Medium",
                    "value": analysis["medium_issues"],
                    "color": "#FFC107",
                },
    ...
    async def _generate_recommendations_section(
        ...
        content_parts = ["## Recommendations", "", "### Priority Recommendations", ""]
    ...
    async def _export_pdf_report(
        ...
        try:
            ...
            # Generate secure temporary file path for PDF
            import os
            import tempfile
    ...
    def get_report(self, report_id: ComplianceReportId) -> ComplianceReport | None:
