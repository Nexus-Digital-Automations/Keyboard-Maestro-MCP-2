...
from .action_builder import ActionCategory, ActionType
...
class ActionRegistry:
    ...
    def _register_text_actions(self):
        ...
        actions = [
            ...
            (
                ...
                ["source", "case_sensitive", "regular_expression"],
            ),
    ...
    def _register_application_actions(self):
        ...
        actions = [
            (
                ...
                ["application"],
                ["bring_all_windows", "launch_if_not_running"],
            ),
    ...
    def _register_system_actions(self):
        ...
        actions = [
            ...
            (
                "Display Dialog",
                ["text"],
                ["title", "buttons", "default_button", "timeout"],
            ),
            (
                "Prompt for User Input",
                ["prompt"],
                ["title", "default_answer", "timeout"],
            ),
        ]
    ...
    def _register_variable_actions(self):
        ...
        actions = [
            ...
            (
                "Get Dictionary Key",
                ["dictionary", "key"],
                ["destination_variable", "default_value"],
            ),
    ...
    def _register_file_actions(self):
        ...
        actions = [
            ...
            (
                "Get File Attributes",
                ["file_path"],
                ["attribute", "destination_variable"],
            ),
            ...
            (
                "Get Folder Contents",
                ["folder_path"],
                ["destination_variable", "recursive"],
            ),
            (
                "Find Files",
                ["search_path", "pattern"],
    ...
    def _register_web_actions(self):
        ...
        actions = [
            ...
            (
                "Post to URL",
                ["url", "data"],
                ["destination_variable", "headers", "timeout"],
            ),
    ...
    def _register_window_actions(self):
        ...
        actions = [
            ...
            (
                "Get Window Position",
                ["window"],
                ["application", "destination_variable"],
            ),
    ...
    def _register_calculation_actions(self):
        ...
        actions = [
            ...
            (
                ...
                ["expression"],
                ["destination_variable", "precision"],
            ),
    ...
    def get_action_type(self, identifier: str) -> ActionType | None:
    ...
    def search_actions(self, query: str) -> list[ActionType]:
        ...
        for action in self._actions.values():
            if (
                query_lower in action.identifier.lower()
    ...
    def validate_action_parameters(
        ...
        missing_required = [
            param for param in action.required_params if param not in parameters
        ]

        # Check for unknown parameters
        all_valid_params = set(action.required_params + action.optional_params)
        unknown_params = [
            param for param in parameters if param not in all_valid_params
        ]
