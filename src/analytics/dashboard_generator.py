...
class DashboardGenerator:
    ...
    def _initialize_dashboard_templates(self):
        ...
        executive_widgets = [
            ...
            DashboardWidget(
                ...
                visualization_config={"max_items": 5, "filter_by_impact": "high"},
    ...
    ) -> Either[ValidationError, Dashboard]:
    ...
    async def _process_table_widget(
        ...
        if data_source == "tool_metrics":
            ...
            return {
                "columns": config.get(
                    "columns",
                    ["tool_name", "response_time", "success_rate", "throughput"],
                ),
                "rows": rows,
        ...
        if data_source == "anomalies":
            ...
            for anomaly in anomalies:
                if (
                    ...
                    and anomaly.severity.value in severity_filter
                ):
    ...
    async def _process_insight_widget(
        ...
        if data_source == "ml_insights":
            ...
            for insight in insights:
                if not impact_filter or (
                    hasattr(insight, "impact_level")
                    and insight.impact_level == impact_filter
                ):
                ...
                trend_data.append(
                    {
                        ...
                        "forecast": [float(v) for v in trend.forecast_values]
                        if display_forecast
                        else [],
                        "confidence_interval": [
    ...
    def _update_generation_stats(self, generation_time_ms: float, widget_count: int):
        ...
        new_avg = (
            current_avg * (total_generated - 1) + generation_time_ms
        ) / total_generated
    ...
    async def get_generation_statistics(self) -> dict[str, Any]:
        ...
        return {
            ...
            "average_generation_time_ms": self.generation_stats[
