...
class FailureIndicator:
    ...
    time_to_threshold: timedelta | None = None
...
class FailurePrediction:
    ...
    prevention_window: timedelta | None = None
...
class FailurePredictor:
    ...
    async def _analyze_failure_indicators(
        ...
        for indicator_name in relevant_indicators:
            ...
            confidence = (
                min(1.0, current_value / threshold_value)
    ...
    def _generate_indicator_specific_strategies(
        ...
        if indicator.indicator_name == "cpu_usage" and indicator.severity.value in [
            "high",
            "critical",
        ]:
            strategies.append(
    ...
    async def generate_early_warning(
        ...
        try:
            ...
            actions = [
                strategy.title for strategy in prediction.mitigation_strategies[:3]
            ]
            ...
            alert = EarlyWarningAlert(
                ...
                auto_mitigation_enabled=prediction.severity
                in [FailureSeverity.CRITICAL, FailureSeverity.CATASTROPHIC],
            )
    ...
    def _generate_alert_message(
        ...
        return (
            f"{alert_level.upper()}: {prediction.failure_type.value} predicted for "
