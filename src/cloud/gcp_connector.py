...
class GCPConnector:
    ...
    async def connect(self, credentials: CloudCredentials) -> Either[CloudError, str]:
        ...
        try:
            ...
            session_id = (
                f"gcp_{int(datetime.now(UTC).timestamp())}_{secrets.token_hex(8)}"
            )
    ...
    async def _validate_gcp_permissions(
        ...
        try:
            ...
            from google.cloud import resourcemanager, storage
    ...
    async def get_session_info(
        ...
        session_info = {
            ...
            "available_services": [
                ...
                GCPServiceType.CLOUD_FUNCTIONS,
                GCPServiceType.PUB_SUB,
                GCPServiceType.AI_PLATFORM,
            ],
        }
