...
from .validation import CommandSecurityError, SecurityValidator
...
class CommandRegistry:
    ...
    def get_command_metadata(self, command_type: CommandType) -> CommandMetadata | None:
    ...
    def get_commands_by_permission(self, permission: Permission) -> list[CommandType]:
        ...
        return [
            cmd_type
            for cmd_type, metadata in self._commands.items()
