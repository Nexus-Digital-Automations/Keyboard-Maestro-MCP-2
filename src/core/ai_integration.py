...
class AIModel:
    ...
    def can_handle_operation(self, operation: AIOperation, input_size: int = 0) -> bool:
        ...
        return not input_size > self.context_window
...
class AIRequest:
    ...
    def validate_for_model(self) -> Either[ValidationError, None]:
        ...
        try:
            ...
            return Either.left(ValidationError("validation_failed", None, str(e)))
...
class AISecurityConfig:
    ...
    def should_scan_content(self, content_size: int) -> bool:
        ...
        return (
            ...
            or self.enable_pii_detection
            or self.enable_malware_scanning
        )
...
def create_ai_request(
    ...
    **kwargs: Any,
    ...
    try:
        ...
        return Either.left(ValidationError("request_creation_failed", None, str(e)))
