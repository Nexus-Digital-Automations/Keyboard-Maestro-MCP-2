...
class ControlFlowValidator:
    ...
    def validate_loop_bounds(self, node: ForLoopNode | WhileLoopNode) -> bool:
...
class AdvancedControlFlowBuilder(ControlFlowBuilder):
    ...
    def build_advanced(
        self,
    ) -> tuple[list[ControlFlowNodeType], list[LoopControl], list[NestedControlFlow]]:
...
class ControlFlowOptimizer:
    ...
    def _optimize_node(self, node: ControlFlowNodeType) -> ControlFlowNodeType | None:
