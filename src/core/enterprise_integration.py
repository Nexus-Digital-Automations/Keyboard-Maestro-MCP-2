...
class EnterpriseError(Exception):
    ...
    def insecure_connection(cls) -> EnterpriseError:
        return cls(
            "INSECURE_CONNECTION",
            "Insecure connection not allowed in enterprise environment",
        )
    ...
    def unsupported_auth_method(cls, method: AuthenticationMethod) -> EnterpriseError:
        return cls(
            ...
            f"Authentication method {method.value} not supported",
        )
    ...
    def initialization_failed(cls, reason: str) -> EnterpriseError:
        return cls(
            ...
            f"Enterprise system initialization failed: {reason}",
        )
    ...
    def unsupported_integration_type(
        ...
        return cls(
            ...
            f"Integration type {integration_type.value} not supported",
        )
    ...
    def connection_establishment_failed(cls, reason: str) -> EnterpriseError:
        return cls(
            ...
            f"Failed to establish connection: {reason}",
        )
    ...
    def insecure_connection_not_allowed(cls) -> EnterpriseError:
        return cls(
            "INSECURE_CONNECTION_NOT_ALLOWED",
            "Insecure connections not allowed in enterprise environment",
        )
    ...
    def certificate_validation_required(cls) -> EnterpriseError:
        return cls(
            ...
            "Certificate validation required for enterprise connections",
        )
    ...
    def weak_authentication_method(cls) -> EnterpriseError:
        return cls(
            ...
            "Weak authentication method not allowed in enterprise environment",
        )
