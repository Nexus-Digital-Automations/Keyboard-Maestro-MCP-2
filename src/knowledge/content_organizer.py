...
class ContentOrganizer:
    ...
    async def analyze_content(
        ...
        try:
            ...
            # Detect topics
            topics = (
                self._detect_topics(content_text)
        ...
        try:
            ...
            for document in documents:
                ...
                if analysis_result.is_right():
                    ...
                    # Group by category
                    organization_results["categories"][
    ...
    async def get_content_recommendations(
        ...
        try:
            ...
            related = [
                ...
                if r.source_id == content_id or r.target_id == content_id
            ]
            recommendations["related_content"] = [
                {
                    "content_id": r.target_id
                    if r.source_id == content_id
                    else r.source_id,
...
# Global instance
_content_organizer: ContentOrganizer | None = None
