...
from src.core.knowledge_architecture import ContentFormat
...
class ContentTemplate:
    ...
    def get_variable_by_name(self, name: str) -> TemplateVariable | None:
...
""",
    ...
    def _render_conditional_sections(
        ...
        def replace_conditional(match: Any) -> dict[str, Any]:
            ...
            if var_name in context.variables:
                ...
                if var_value and (
                    not isinstance(var_value, list) or len(var_value) > 0
                ):
    ...
    def _clear_template_cache(self, template_id: str) -> None:
        ...
        keys_to_remove = [
            key for key in self.template_cache if key.startswith(template_id)
        ]
