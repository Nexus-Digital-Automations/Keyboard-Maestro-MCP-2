    ...
    def is_allowed(self, plugin_id: PluginId, tool_name: str, limit: int) -> bool:
        ...
        if key in self.call_history:
            self.call_history[key] = [
                call_time
                for call_time in self.call_history[key]
...
class PluginAPIBridge:
        ...
        self.available_tools = {
            ...
            "km_window_manager_advanced": MCPToolDefinition(
                ...
                permissions_required={
                    PermissionId("window_control"),
                    PermissionId("display_access"),
                },
                security_level=SecurityProfile.STRICT,
                rate_limit=30,
                resource_cost=3,
    ...
    async def _validate_security(
        ...
        try:
            ...
            if (
                ...
                and plugin_security_level
                not in {SecurityProfile.STRICT, SecurityProfile.SANDBOX}
            ):
                return Either.left(
    ...
    def get_plugin_metrics(self, plugin_id: PluginId) -> dict[str, Any]:
        ...
        total_resource_cost = sum(
            m.total_resource_cost for m in plugin_metrics.values()
        )
        ...
        return {
            ...
            "tool_usage": {
                tool_name: {
                    ...
                    "last_used": metrics.last_call.isoformat()
