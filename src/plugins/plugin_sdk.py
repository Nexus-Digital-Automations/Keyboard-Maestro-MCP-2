...
class BasePlugin(PluginInterface):
    ...
    def __init__(
        ...
        self._api_bridge: PluginAPIBridge | None = None
        self._logger: PluginLogger | None = None
    ...
    @property
    def api(self) -> PluginAPIBridge | None:
    ...
    async def initialize(
        ...
        try:
            ...
            self.logger.info(
                "Plugin initializing",
                api_version=api_bridge.api_config["version"].value,
            )
...
# TODO: Fix forward reference issue with UtilityPlugin
# Temporarily commented out to allow property-based tests to run
