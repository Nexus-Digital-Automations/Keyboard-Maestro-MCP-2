...
class OptimizationEngine:
    ...
    def __init__(
        self,
        model_manager: PredictiveModelManager | None = None,
        performance_predictor: PerformancePredictor | None = None,
        ecosystem_orchestrator: EcosystemOrchestrator | None = None,
    ...
    async def _analyze_workflow_optimizations(
        ...
        try:
            ...
            if (
                context.system_health > 0.8
            ):  # Only optimize workflows when system is healthy
                suggestion = OptimizationSuggestion(
                    optimization_id=create_optimization_id(),
    ...
    def get_optimization_history(
        ...
        if optimization_type:
            history = [
                opt for opt in history if opt.optimization_type == optimization_type
            ]
