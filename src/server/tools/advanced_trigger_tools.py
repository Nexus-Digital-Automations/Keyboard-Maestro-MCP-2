...
def _validate_trigger_type(trigger_type: str) -> Either[ValidationError, TriggerType]:
    ...
    try:
        ...
        list(TriggerType) + list(type_mapping.keys())
        return Either.left(
            ValidationError(
...
def create_scheduled_trigger_helper(
    ...
    return {
        ...
        "trigger_config": {"schedule_time": schedule_time, "timezone": timezone},
    }
...
def create_file_monitor_helper(
    ...
    return {"trigger_type": "file_modified", "trigger_config": config}
