        ...
        if result.is_left():
            ...
            return {
                ...
                "error": {
                    ...
                    or "Check application name and permissions",
                },
            }
        ...
        if result.is_left():
            ...
            return {
                ...
                "error": {
                    ...
                    "details": error.details,
                    "recovery_suggestion": error.recovery_suggestion
                    or "Check if application is running",
                },
            }
        ...
        if result.is_left():
            ...
            return {
                ...
                "error": {
                    ...
                    "details": error.details,
                    "recovery_suggestion": error.recovery_suggestion
                    or "Ensure application is running",
                },
            }
        ...
        if result.is_left():
            ...
            return {
                ...
                "error": {
                    ...
                    "details": error.details,
                    "recovery_suggestion": error.recovery_suggestion
                    or "Check menu path exists and application is active",
                },
            }
        ...
        if result.is_left():
            ...
            return {
                ...
                "error": {
                    ...
                    "details": error.details,
                    "recovery_suggestion": error.recovery_suggestion
                    or "Check application identifier",
                },
            }
