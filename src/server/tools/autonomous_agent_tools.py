...
from fastmcp.exceptions import ToolError as InternalError
from fastmcp.exceptions import ValidationError as InvalidParams
        ...
        if operation == "create":
            ...
            if agent_config:
                ...
                if "max_concurrent_actions" in agent_config:
                    config.max_concurrent_actions = agent_config[
