...
from ...clipboard import ClipboardFormat, ClipboardManager, NamedClipboardManager

# Global instances for clipboard management
_clipboard_manager: ClipboardManager | None = None
_named_clipboard_manager: NamedClipboardManager | None = None
...
async def km_clipboard_manager(
    ...
    tags: Annotated[
        list[str] | None,
        Field(default=None, description="Tags for named clipboard organization"),
    ] = None,
        ...
        if operation == "get":
            ...
            return {
                ...
                "data": {
                    ...
                    if not content_obj.is_sensitive or include_sensitive
                ...
                "metadata": {
                    "operation": "get",
                    "security_filtered": content_obj.is_sensitive
                    ...
                    "history": [
                        {
                            ...
                            if not item.is_sensitive or include_sensitive
                            else "[SENSITIVE CONTENT HIDDEN]",
        ...
        if operation == "manage_named":
            ...
            if content is not None:
                ...
                return {
                    ...
                    "metadata": {"operation": "create_named"},
                }
