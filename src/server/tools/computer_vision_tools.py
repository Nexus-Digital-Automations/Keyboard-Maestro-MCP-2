...
def _update_performance_metrics(operation: str, response_time: float) -> None:
    ...
    total_ops = (
        vision_performance_metrics["total_detections"]
    ...
    try:
        ...
        if filter_categories:
            detected_objects = [
                ...
                if obj.category.value in filter_categories
                or obj.class_name in filter_categories
            ]
        ...
        response["detection_statistics"] = {
            "total_detections_session": detection_stats["performance_metrics"][
                "total_detections"
            ],
            "average_detection_time": detection_stats["performance_metrics"][
    ...
    try:
        ...
        if detected_objects:
            response["detected_objects"] = {
                ...
                "categories": list({obj.category.value for obj in detected_objects}),
                "primary_objects": [
                    {
                        "class_name": obj.class_name,
                        "confidence": obj.confidence,
        ...
        response["analysis_statistics"] = {
            "total_analyses_session": analysis_stats["performance_metrics"][
                "total_analyses"
            ],
            "average_analysis_time": analysis_stats["performance_metrics"][
...
async def km_classify_image_content(
    ...
    try:
        ...
        if classification_type == "general":
            ...
            classification_results.extend(
                [
                    ...
                    },
                    {
                        ...
                        if scene_analysis.scene_type.value
                        in ["desktop", "website", "application"]
                        else "physical_content",
                        "confidence": 0.9
                        if scene_analysis.scene_type.value
                        in ["desktop", "website", "application"]
                        else 0.8,
            ...
            ui_objects = [
                obj for obj in detected_objects if obj.category.value == "ui_element"
            ]
            if ui_objects:
            ...
            text_objects = [
                obj for obj in detected_objects if obj.category.value == "text"
            ]
                ...
                classification_results.append(
                    {
                        ...
                        "confidence": 0.9
                        if scene_analysis.scene_type.value == "document"
                        else 0.7,
                        "type": "document_type",
        ...
        if custom_categories:
            for category in custom_categories:
                ...
                if category.lower() in scene_analysis.description.lower():
                    ...
                    category.lower() in obj.class_name.lower()
                    for obj in detected_objects
                ):
                    confidence = 0.7
        ...
        response = {
            ...
            "primary_category": limited_results[0]["category"]
            if limited_results
            else "unknown",
            "primary_confidence": limited_results[0]["confidence"]
            if limited_results
            else 0.0,
            ...
            response["probabilities"] = [
                {
                    ...
                    "probability": result["confidence"] / total_confidence
...
async def km_extract_text_from_image(
    ...
    try:
        ...
        if filter_noise:
            extracted_text_regions = [
                region
                for region in extracted_text_regions
        ...
        response = {
            ...
            "extracted_text": {
                ...
                "average_confidence": sum(
                    r["confidence"] for r in extracted_text_regions
                )
        ...
        if preserve_layout and extracted_text_regions:
            response["layout_analysis"] = {
                ...
                "text_density": len(full_text_content)
                / (len(extracted_text_regions) * 100)
                if extracted_text_regions
                else 0.0,
            }
        ...
        if extracted_text_regions:
            high_confidence_regions = [
                r for r in extracted_text_regions if r["confidence"] > 0.8
            ]
            response["quality_assessment"] = {
                "overall_quality": "high"
                if len(high_confidence_regions) > len(extracted_text_regions) * 0.7
                else "medium",
...
async def km_computer_vision_metrics() -> dict[str, Any]:
    ...
    try:
        ...
        metrics = {
            ...
            "object_detection": {
                "total_detections": detection_stats["performance_metrics"][
                    "total_detections"
                ],
                "average_detection_time": detection_stats["performance_metrics"][
                    "average_detection_time"
            ...
            "scene_analysis": {
                ...
                "average_analysis_time": scene_stats["performance_metrics"][
                    "average_analysis_time"
                ],
