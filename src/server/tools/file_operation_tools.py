...
async def km_file_operations(
    ...
    try:
        ...
        if result.is_right():
            ...
            response = {
                ...
                "metadata": {
                    ...
                    "execution_time": operation_result.execution_time.total_seconds()
                    if operation_result.execution_time
                    else None,
        ...
        error_response = {
            ...
            "error": {
                ...
                "details": {
                    ...
                    if "Source path" in str(e)
                    else destination_path,
                },
            },
            "security_status": {"path_validated": False, "security_violation": True},
            "metadata": {
                "timestamp": datetime.now(UTC).isoformat(),
                "operation_id": str(uuid.uuid4()),
            },
        ...
        error_response = {
            ...
            "security_status": {"path_validated": True, "permission_denied": True},
            "metadata": {
                "timestamp": datetime.now(UTC).isoformat(),
                "operation_id": str(uuid.uuid4()),
            },
        ...
        error_response = {
            ...
            "security_status": {"path_validated": True, "unexpected_error": True},
            "metadata": {
                "timestamp": datetime.now(UTC).isoformat(),
                "operation_id": str(uuid.uuid4()),
            },
