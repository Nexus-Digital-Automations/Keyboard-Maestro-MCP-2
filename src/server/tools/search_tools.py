...
async def km_search_actions(
    ...
    macro_filter: Annotated[
        str | None,
        Field(default=None, description="Search within specific macro by name or UUID"),
    ] = None,
    ...
    try:
        ...
        if macro_filter:
            ...
            macros = [
                m
                for m in macros
                if macro_filter_lower in m.get("name", "").lower()
                or m.get("id", "") == macro_filter
            ]
        ...
        for macro in macros:
            ...
            for action in mock_actions:
                ...
                if category:
                    ...
                    if not any(
                        keyword in action_type_name for keyword in category_keywords
                    ):
                        continue
