...
from ...identity.privacy_manager import PrivacyManager
from ...identity.session_manager import SessionManager, SessionSwitchRequest
from ...identity.user_profiler import PersonalizationContext, UserProfiler
    ...
    try:
        ...
        try:
            ...
            return {
                ...
                "supported_methods": [
                    method.value.lower() for method in AuthenticationMethod
                ],
        ...
        return {
            ...
            "session_context": {
                "isolation_level": session_context.isolation_level
                if session_context
                else "none",
...
async def km_identify_user(
    ...
    try:
        ...
        try:
            priv_level = PrivacyLevel(privacy_level.lower())
        except ValueError:
            return {
                "success": False,
        ...
        response_data["profile_metadata"] = {
            ...
            "last_authenticated": user_profile.last_authenticated.isoformat()
            if user_profile.last_authenticated
            else None,
...
async def km_personalize_automation(
    ...
    """
    if personalization_scope is None:
    ...
    try:
        ...
        return {
            ...
            "predictions": {
                ...
                "predicted_patterns": ["continued_usage", "preference_stability"]
