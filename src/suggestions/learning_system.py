...
class LearningInsight:
    ...
    def is_actionable(self, threshold: float = 0.8) -> bool:
        ...
        return self.confidence >= threshold and self.priority in [
            PriorityLevel.HIGH,
...
class AdaptiveLearningSystem:
    ...
    async def process_feedback(
        ...
        try:
            ...
            if (
                len(self.feedback_history[feedback.user_id])
    ...
    def get_user_learning_stats(self, user_id: str) -> dict[str, Any]:
        ...
        try:
            ...
            recent_feedback = [
                f for f in feedback_list if (datetime.now(UTC) - f.timestamp).days <= 7
            ]

            # Calculate satisfaction scores
            satisfaction_scores = [
                f.get_satisfaction_score()
        ...
        try:
            ...
            if feedback.accepted:
                ...
                new_weight = current_weight + (
                    profile.learning_rate * satisfaction_multiplier
                )
    ...
    async def _update_adaptation_metrics(self, feedback: SuggestionFeedback) -> None:
        ...
        try:
            ...
            metrics["average_satisfaction"] = (
                (current_avg * (total - 1)) + satisfaction
            ) / total

            # Calculate learning velocity (improvement rate)
            recent_feedback = self.feedback_history[user_id][
                -10:
    ...
    async def _generate_learning_insights(self, user_id: str) -> None:
        ...
        try:
            ...
            satisfaction_scores = [
                f.get_satisfaction_score() for f in recent_feedback if f.accepted
            ]
