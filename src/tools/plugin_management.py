...
from ..core.plugin_architecture import PluginId, SecurityProfile
from ..plugins.marketplace import PluginCategory, PluginMarketplace, SearchQuery
    ...
    **kwargs,
    ...
    try:
        ...
        if operation == "list":
            ...
            return {
                "success": True,
                "data": {"plugins": plugins, "total_count": len(plugins)},
    ...
    try:
        ...
        if operation == "search":
            ...
            return {
                ...
                "data": {
                    "plugins": [
                        _serialize_marketplace_entry(entry) for entry in plugins
                    ],
            ...
            return {
                ...
                "data": {
                    "featured_plugins": [
                        _serialize_marketplace_entry(entry) for entry in featured
                    ],
                    "count": len(featured),
                },
            }
    ...
    try:
        if operation == "create_template":
            ...
            if result.is_left():
                ...
                return {
                    "success": False,
                    "error": {"code": "VALIDATION_FAILED", "message": error_msg},
                }
    ...
    "km_plugin_marketplace": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "category": {"type": "string", "description": "Plugin category filter"},
    ...
    "km_plugin_actions": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "plugin_id": {"type": "string", "description": "Filter by plugin"},
    ...
    "km_plugin_development": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "plugin_name": {"type": "string", "description": "Name for new plugin"},
                "template_type": {
                    "type": "string",
