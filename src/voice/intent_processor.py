...
class EntityExtractor:
    ...
    def extract_specific_entity(self, text: str, entity_type: str) -> str | None:
        ...
        self.intent_patterns.extend(
            [
                IntentPattern(
                    ...
                    examples=["open safari", "launch mail", "switch to finder"],
                ),
                IntentPattern(
        ...
        self.intent_patterns.extend(
            [
                IntentPattern(
                    ...
                    examples=["set volume to 50", "turn volume up", "mute sound"],
                ),
                IntentPattern(
