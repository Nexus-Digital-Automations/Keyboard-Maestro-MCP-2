...
class TestCompleteWorkflows:
    ...
    def test_complex_multi_command_workflow(self) -> None:
        ...
        assert len(result.command_results) == len(command_types), (
            "Should have result for each command"
        )
        ...
        for i, cmd_result in enumerate(result.command_results):
            ...
            assert cmd_result.execution_time is not None, (
    ...
    def test_error_handling_workflow(self) -> None:
        ...
        assert (
            "SYSTEM_SOUND" in result.error_details
...
class TestRealisticScenarios:
    ...
    def test_error_recovery_scenario(self) -> None:
        ...
        try:
            ...
            if result.status == ExecutionStatus.FAILED:
                assert result.has_error_info(), (
                    "Failed execution should have error info"
                )
        except Exception as e:
    ...
    def test_performance_sensitive_scenario(self) -> None:
        ...
        macro = create_test_macro(
            ...
            [CommandType.TEXT_INPUT, CommandType.PAUSE, CommandType.TEXT_INPUT],
        )
        ...
        assert result.total_duration.total_seconds() < 2.0, (
            "Recorded duration should be reasonable"
        )
...
class TestSystemIntegration:
    ...
    def test_resource_management_integration(self) -> None:
        ...
        assert context_manager.get_context(token) is None, (
