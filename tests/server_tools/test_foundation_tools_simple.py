        ...
        for module_name in modules_to_test:
            try:
                ...
                assert hasattr(module, "__doc__"), (
                    f"{module_name} should have docstring"
                )
                assert module.__doc__ is not None, (
                    f"{module_name} docstring should not be None"
                )
            except ImportError:
        ...
        for module_name, function_name in tools_with_docs:
            try:
                ...
                assert func.__doc__ is not None, (
                    f"{function_name} should have docstring"
                )
                assert len(func.__doc__.strip()) > 0, (
                    f"{function_name} docstring should not be empty"
                )
