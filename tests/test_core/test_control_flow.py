...
class TestActionBlock:
    ...
    def test_invalid_action_block(self) -> None:
        ...
        with pytest.raises(ContractViolationError):
            ActionBlock(actions=[{"type": "test"}], timeout_seconds=0)
...
class TestControlFlowBuilder:
    ...
    def test_switch_case(self) -> None:
        ...
        self.builder.switch_on("frontmost_application", cases, default_actions)
...
class TestHelperFunctions:
    ...
    def test_create_for_loop(self) -> None:
        ...
        for_node = create_for_loop("item", "collection", actions, max_iterations=100)
