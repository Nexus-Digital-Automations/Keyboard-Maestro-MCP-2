...
class TestResultFunctions:
    ...
    def test_create_success_result_with_none(self):
    ...
    def test_create_success_result_with_complex_object(self):
    ...
    def test_create_error_result_empty_message(self):
...
class TestResultClass:
    ...
    def test_result_status_methods(self):
    ...
    def test_result_message_property(self):
...
class TestDurationClass:
    ...
    def test_duration_total_seconds(self):
    ...
    def test_duration_comparison_le(self):
    ...
    def test_duration_comparison_gt(self):
    ...
    def test_duration_comparison_ge(self):
...
class TestEnums:
    ...
    def test_move_conflict_type_enum_values(self):
    ...
    def test_macro_creation_status_enum_values(self):
...
class TestDataClasses:
    ...
    def test_command_parameters_get_method(self):
    ...
    def test_command_parameters_empty_factory(self):
    ...
    def test_execution_context_permission_checks(self):
    ...
    def test_execution_context_factory_methods(self):
    ...
    def test_command_result_factory_methods(self):
    ...
    def test_macro_definition_validation(self):
    ...
    def test_execution_result_success_check(self):
