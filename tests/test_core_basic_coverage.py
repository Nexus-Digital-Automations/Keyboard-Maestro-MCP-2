...
try:
    from src.core.types import (
        MacroId, GroupId, CommandId, ExecutionToken, TriggerId,
        VariableName, TemplateId, create_macro_id
    )
...
class TestCoreTypes:
    ...
    def test_type_creation(self):
        ...
        exec_token = ExecutionToken("test-token")
...
class TestEitherMonad:
    ...
    @pytest.mark.skipif(not EITHER_AVAILABLE, reason="Either module not available")
    def test_either_flat_map_right(self):
    ...
    @pytest.mark.skipif(not EITHER_AVAILABLE, reason="Either module not available")
    def test_either_flat_map_left(self):
...
class TestCoreContracts:
    ...
    def test_contracts_import(self):
        ...
        try:
            from src.core.contracts import require, ensure, invariant
