...
from src.integration.km_client import ConnectionConfig, Either, KMClient
...
class TestTriggerRegistrationManager:
    ...
    @pytest.fixture
    def trigger_manager(self, mock_km_client: Any) -> bool:
...
class TestEventRouter:
    ...
    async def test_successful_event_routing(
        self,
        event_router: Any,
        mock_macro_engine: Any,
        mock_trigger_manager: Any,
        sample_trigger_info: Any,
        sample_km_event: Any,
    ) -> None:
...
def test_km_event_payload_properties(payload_data: Any) -> None:
...
if __name__ == "__main__":
    ...
    try:
        ...
        from src.integration.km_client import ConnectionConfig, KMClient
        from src.integration.triggers import EventRouter, TriggerRegistrationManager
