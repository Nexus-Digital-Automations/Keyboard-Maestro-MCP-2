...
try:
    ...
    from src.server.initialization import get_km_client, initialize_components
    from src.server.resources import (
        create_macro_prompt,
        get_server_status,
        get_tool_help,
    )
    from src.server.utils import sanitize_output, validate_input
...
class TestMainEntryPoint:
    ...
    def test_main_function_execution(self) -> None:
        ...
        with (
            patch("src.main.create_mcp_server") as mock_create,
...
class TestServerInitialization:
    ...
    async def test_initialize_components(self) -> None:
        ...
        with (
            patch("src.server.initialization.setup_logging") as mock_logging,
...
class TestServerResources:
    ...
    def test_get_server_status(self) -> None:
        ...
        with (
            patch("src.server.resources.get_system_info") as mock_system,
    ...
    def test_prompt_validation(self) -> None:
        ...
        invalid_prompt = {"description": "Missing name"}
...
class TestServerConfig:
    ...
    def test_server_config_creation(self) -> None:
        ...
        config = ServerConfig(host="localhost", port=8080, debug=True, log_level="INFO")
    ...
    def test_server_config_validation(self) -> None:
        ...
        # Valid config
        valid_config = ServerConfig(host="127.0.0.1", port=9000, debug=False)
...
class TestServerUtils:
    ...
    def test_input_validation_schemas(self) -> None:
        ...
        # Valid input
        valid_input = {"macro_name": "Test Macro", "enabled": True, "priority": 5}
...
class TestServerIntegration:
    ...
    async def test_full_server_startup(self) -> None:
        ...
        with (
            patch("src.server.initialization.initialize_components") as mock_init,
            patch("src.main.FastMCP") as mock_fastmcp,
        ):
