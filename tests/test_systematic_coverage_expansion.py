...
class TestCoreModulesExpansion:
    ...
    def test_core_context_comprehensive(self):
    ...
    def test_core_errors_comprehensive(self):
        ...
        try:
            ...
            chained_error = ExecutionError("Execution failed due to validation", cause=e)
            assert chained_error.cause == e
    
    def test_core_contracts_comprehensive(self):
        """Comprehensive test for core.contracts module."""
        from src.core.contracts import require, ensure, Contract
    ...
    def test_core_parser_comprehensive(self):
        ...
        from src.core.parser import MacroParser, CommandParser
...
class TestIntegrationModulesExpansion:
    ...
    def test_km_client_comprehensive(self, mock_run):
    ...
    def test_sync_manager_comprehensive(self):
    ...
    def test_policy_enforcer_comprehensive(self):
        ...
        policy = {
            ...
            "rules": [
                ...
                {"field": "resource_type", "operator": "in", "value": ["file", "macro"]}
            ]
        }
...
class TestCommunicationModulesExpansion:
    ...
    @patch('subprocess.run')
    def test_email_manager_advanced(self, mock_run):
    ...
    @patch('subprocess.run')
    def test_sms_manager_advanced(self, mock_run):
        ...
        rendered = manager.render_template("reminder_template", {
            "event": "Meeting",
            "time": "2:00 PM"
        })
...
class TestFileSystemModulesExpansion:
    ...
    def test_file_operations_comprehensive(self, mock_write, mock_read, mock_exists):
...
class TestWebAndAPIModulesExpansion:
    ...
    @patch('httpx.Client')
    def test_http_client_comprehensive(self, mock_client):
...
class TestClipboardModulesExpansion:
    ...
    @patch('subprocess.run')
    def test_clipboard_manager_advanced(self, mock_run):
    ...
    @patch('subprocess.run')
    def test_named_clipboards_advanced(self, mock_run):
