...
class TestCalculatorToolsIntegration:
    ...
    @pytest.mark.asyncio
    async def test_km_calculate_expression_validation_error(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_km_calculate_expression_security_error(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_km_calculate_math_function_validation(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_km_convert_number_format_validation(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_km_evaluate_formula_validation(self) -> None:
    ...
    async def test_concurrent_calculations(self, mock_calculator: Any) -> None:
        ...
        def mock_calculate_side_effect(calc_expression: Any) -> bool:
            ...
            if "cos(0)" in calc_expression.expression:
                return Either.right(
                    CalculationResult(
                        result=1.0,
                        formatted_result="1.0",
            ...
            if "10" in calc_expression.expression:
                return Either.right(
                    CalculationResult(
                        result=10.0,
                        formatted_result="10",
...
class TestCalculatorSecurityValidation:
    ...
    @pytest.mark.asyncio
    async def test_dangerous_expression_rejection(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_expression_length_limits(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_variable_name_validation(self) -> None:
