...
class TestEngineOperations:
    ...
    @pytest.mark.asyncio
    async def test_reload_operation_success(self, mock_context, mock_km_client):
    ...
    @pytest.mark.asyncio
    async def test_status_operation_success(self, mock_context, mock_km_client):
    ...
    async def test_calculate_operation_success(
        self, mock_context, mock_km_client, valid_expression
    ):
        ...
        with patch(
            ...
            result = await km_engine_control(
                operation="calculate", expression=valid_expression, ctx=mock_context
            )
    ...
    async def test_process_tokens_operation_success(
        self, mock_context, mock_km_client, valid_token_string
    ):
    ...
    async def test_search_replace_operation_success(
        self, mock_context, mock_km_client, valid_search_text
    ):
    ...
    @pytest.mark.asyncio
    async def test_regex_search_replace_success(self, mock_context, mock_km_client):
...
class TestEngineErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_missing_expression_for_calculate(self, mock_context):
        """Test error when expression is missing for calculate operation."""
        with patch("src.server.tools.engine_tools.get_km_client"):
            result = await km_engine_control(
                operation="calculate", expression=None, ctx=mock_context
            )
    ...
    @pytest.mark.asyncio
    async def test_missing_expression_for_process_tokens(self, mock_context):
        """Test error when expression is missing for process_tokens operation."""
        with patch("src.server.tools.engine_tools.get_km_client"):
            result = await km_engine_control(
                operation="process_tokens", expression=None, ctx=mock_context
            )
    ...
    @pytest.mark.asyncio
    async def test_missing_search_pattern_for_search_replace(self, mock_context):
    ...
    @pytest.mark.asyncio
    async def test_missing_text_for_search_replace(self, mock_context):
    ...
    @pytest.mark.asyncio
    async def test_km_connection_failure(self, mock_context, mock_km_client):
    ...
    @pytest.mark.asyncio
    async def test_invalid_operation(self, mock_context, mock_km_client):
...
class TestExpressionSecurity:
    ...
    async def test_forbidden_operations_in_expression(
        ...
        for expression in dangerous_expressions:
            with patch(
                ...
                result = await km_engine_control(
                    operation="calculate", expression=expression, ctx=mock_context
                )
    ...
    @pytest.mark.asyncio
    async def test_invalid_characters_in_expression(self, mock_context, mock_km_client):
        ...
        with patch(
            ...
            result = await km_engine_control(
                operation="calculate", expression=invalid_expression, ctx=mock_context
            )
    ...
    @pytest.mark.asyncio
    async def test_calculation_error_handling(self, mock_context, mock_km_client):
    ...
    @pytest.mark.asyncio
    async def test_complex_valid_expression(self, mock_context, mock_km_client):
...
class TestHelperFunctions:
    ...
    @pytest.mark.asyncio
    async def test_reload_engine_function(self, mock_context):
    ...
    @pytest.mark.asyncio
    async def test_get_engine_status_function(self, mock_context, mock_km_client):
    ...
    @pytest.mark.asyncio
    async def test_calculate_expression_function(self, mock_context):
    ...
    @pytest.mark.asyncio
    async def test_process_tokens_function(self, mock_context):
        """Test the _process_tokens helper function directly."""
        mock_km_client = Mock()
        token_string = "User: %CurrentUser%, Volume: %SystemVolume%"
    ...
    @pytest.mark.asyncio
    async def test_search_replace_function(self, mock_context):
        ...
        result = await _search_replace(
            mock_km_client, text, search_pattern, replace_pattern, False, mock_context
        )
...
class TestEngineIntegration:
    ...
    @pytest.mark.asyncio
    async def test_complete_engine_workflow(self, mock_context, mock_km_client):
        ...
        with patch(
            ...
            status_result = await km_engine_control(
                operation="status", ctx=mock_context
            )
            assert status_result["success"] is True

            # Test calculation
            calc_result = await km_engine_control(
                operation="calculate", expression="10 + 5", ctx=mock_context
            )
    ...
    @pytest.mark.asyncio
    async def test_complex_search_replace_workflow(self, mock_context, mock_km_client):
...
class TestEngineContext:
    ...
    @pytest.mark.asyncio
    async def test_context_info_logging(self, mock_context, mock_km_client):
    ...
    @pytest.mark.asyncio
    async def test_context_error_logging(self, mock_context, mock_km_client):
    ...
    @pytest.mark.asyncio
    async def test_without_context(self, mock_km_client):
...
class TestEngineSecurity:
    ...
    @pytest.mark.asyncio
    async def test_expression_injection_prevention(self, mock_context, mock_km_client):
    ...
    @pytest.mark.asyncio
    async def test_regex_safety_validation(self, mock_context, mock_km_client):
    ...
    @pytest.mark.asyncio
    async def test_large_input_handling(self, mock_context, mock_km_client):
...
class TestEnginePropertyBased:
    ...
    @composite
    def valid_arithmetic_expressions(draw):
    ...
    @composite
    def valid_search_patterns(draw):
    ...
    def test_arithmetic_expression_property(self, expression):
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    def test_search_pattern_property(self, pattern):
...
class TestEnginePerformance:
    ...
    @pytest.mark.asyncio
    async def test_engine_operation_response_time(self, mock_context, mock_km_client):
    ...
    @pytest.mark.asyncio
    async def test_calculation_performance(self, mock_context, mock_km_client):
    ...
    @pytest.mark.asyncio
    async def test_large_text_search_performance(self, mock_context, mock_km_client):
...
class TestEngineEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_empty_expression_handling(self, mock_context, mock_km_client):
        """Test handling of empty expressions."""
        with patch(
            "src.server.tools.engine_tools.get_km_client", return_value=mock_km_client
        ):
            result = await km_engine_control(
                operation="calculate", expression="", ctx=mock_context
            )
    ...
    @pytest.mark.asyncio
    async def test_unicode_token_processing(self, mock_context, mock_km_client):
        """Test token processing with Unicode characters."""
        unicode_token_string = "测试 %CurrentUser% 🌍 %SystemVolume%"
    ...
    @pytest.mark.asyncio
    async def test_complex_regex_patterns(self, mock_context, mock_km_client):
    ...
    @pytest.mark.asyncio
    async def test_edge_case_calculations(self, mock_context, mock_km_client):
    ...
    @pytest.mark.asyncio
    async def test_regex_case_sensitivity(self, mock_context, mock_km_client):
    ...
    @pytest.mark.asyncio
    async def test_zero_matches_search(self, mock_context, mock_km_client):
