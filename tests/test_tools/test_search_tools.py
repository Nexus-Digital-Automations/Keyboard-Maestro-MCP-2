...
@composite
def valid_search_parameters(draw: Callable[..., Any]) -> Mock:
...
@composite
def malicious_search_inputs(draw: Callable[..., Any]) -> Mock:
...
class TestKMSearchActions:
    ...
    @pytest.mark.asyncio
    async def test_search_actions_macro_fetch_error(
        self,
        mock_context: Any,
        mock_km_client: Any,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_search_actions_empty_results(
        self,
        mock_context: Any,
        mock_km_client: Any,
    ) -> None:
...
class TestSearchToolsIntegration:
    ...
    @pytest.mark.asyncio
    async def test_complex_search_workflow(
        self,
        mock_context: Any,
        mock_km_client: Any,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_search_pagination_behavior(
        self,
        mock_context: Any,
        mock_km_client: Any,
    ) -> None:
...
class TestSearchToolsEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_search_with_empty_macro_list(
        self,
        mock_context: Any,
        mock_km_client: Any,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_search_without_context(
        self,
        mock_km_client: Any,
        sample_macros_list: list[Any],
    ) -> None:
